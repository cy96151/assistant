...
!function($) {
	$.fn.Spinner = function(opts) {
		...
		function f(o, t, c, s) {
			t == 0
					&& o.addClass(c).attr("href", "javascript:void(0)").append(
							"<i></i>").find("i").append(s);
				...
				function() {
					if ($(this).next().is(":visible")) {
						if (obj_type == 2) {
							...
							$(this).next().slideUp(speed).end().removeClass(
									"selected");
							if ($(this).find("b")) {
								$(this).find("b").html("+")
							}
						...
						if (obj_type == 3) {
							$(this).next().slideDown(speed).end().addClass(
									"selected");
							if ($(this).find("b")) {
								$(this).find("b").html("-")
							}
			...
			function(event) {
				...
				if (v != "") {
					...
					if (event.keyCode == 8) {
						if (token.length >= 1) {
							$(this).parents(".Hui-tags").find(
									".Hui-tags-token:last").remove();
							gettagval(this)
						} else {
							$(this).parents(".Hui-tags")
									.find(".Hui-tags-lable").show();
							return false
						}
					}
				}
